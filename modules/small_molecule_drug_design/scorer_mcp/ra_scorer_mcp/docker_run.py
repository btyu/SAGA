    ...
    def run_in_docker(
        ...
        try:
            ...
            try:
                ...
                output = self.current_container.attach(
            ...
            try:
                ...
                if self.current_container:
                    logger.debug(
                        f"Stopping and removing container {self.current_container.short_id}..."
                    )
...
def main():
    ...
    parser.add_argument(
        "--scorer_name", type=str, required=True, help="Name of the scorer"
    )
